...
def train_data_loader(cfg):    
    ...
    tf_covidxray = transforms.Compose(
    ...
    elif cfg.DATASET_NAME == "Covid_XRay":
        print("Hiiii")
        my_dataset = CustomDataSet('/content/drive/MyDrive/covid_data/train', transform=tf_covidxray)
        print(my_dataset)
        train_loader=DataLoader(my_dataset , batch_size=cfg.BATCH_SIZE, shuffle=False,drop_last=True)
        print(train_loader)
        return train_loader
...
def val_data_loader(cfg):    
    ...
    if cfg.DATASET_NAME == "MNIST":
        ...
        print("Hiiii")
        my_dataset = CustomDataSet('/content/drive/MyDrive/covid_data/test', transform=tf_covidxray)
        print(my_dataset)
        train_loader=DataLoader(my_dataset , batch_size=cfg.BATCH_SIZE, shuffle=False,drop_last=True)
        print(train_loader)
        return train_loader
